...
urlpatterns = [
    ...
    path("projects/<slug:slug>/locations/world-map/", views.LocationWorldMapView.as_view(), name="location-world-map"),
    path("projects/<slug:slug>/locations/new/", views.LocationCreateView.as_view(), name="location-create"),
    path("projects/<slug:slug>/locations/move/", views.move_location, name="location-move"),
    ...
    path(
        "projects/<slug:slug>/outline/scenes/rename/",
        views.rename_scene_title,
        name="scene-rename",
    ),
    path(
